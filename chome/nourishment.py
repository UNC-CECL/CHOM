...
def calculate_nourishment_plan_cost(time_index, agentsame, mgmt, agent_of, agent_nof):
    t = time_index
...
def evaluate_nourishment_plans(time_index, mgmt, agent_of, agent_nof, agentsame):
    t = time_index
    ...
    #     mgmt._newplan[t + 1] = 1
    #     if mgmt._nourishment_menu_add_tax[voter_choice] > 0:
    #         mgmt._nourishment_menu_add_tax[voter_choice] = 0
    #     agent_nof._tau_prop[t + 1 : t + mgmt._amort + 1] = (
    #         agent_nof._tau_prop[t + 1 : t + mgmt._amort + 1]
    #         + mgmt._nourishment_menu_add_tax[voter_choice]
    #     )
    #     agent_of._tau_prop[t + 1 : t + mgmt._amort + 1] = (
    #         agent_of._tau_prop[t + 1 : t + mgmt._amort + 1]
    #         + mgmt._taxratio_OF * mgmt._nourishment_menu_add_tax[voter_choice]
    #     )
